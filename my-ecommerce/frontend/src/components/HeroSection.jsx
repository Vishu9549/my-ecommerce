  ...
  useEffect(() => {
    const interval = setInterval(() => {
      setCurrentIndex(prev =>
        prev + 1 < sliders.length ? prev + 1 : 0
      );
    }, 10000);
        ...
        <div className="row align-items-center">
          ...
          <div className="col-lg-6">
            <div className="intro-excerpt">
              ...
              <p className="mb-4">{currentSlider.subtitle || "Welcome to our store. Explore amazing collections!"}</p>
              <p>
                <a href="/shop" className="btn btn-secondary me-2">Shop Now</a>
                <a href="#why-choose" className="btn btn-white-outline">Explore</a>
              </p>
            </div>
          </div>
          ...
          <div className="col-lg-6 text-center">
            <div className="hero-img-wrap">
              <img
                ...
                onError={(e) => { e.target.src = "/images/default-hero.png"; }}
              />
            </div>
          </div>
        </div>
