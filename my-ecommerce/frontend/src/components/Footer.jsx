    ...
    <footer className="footer-section ">
      <div className="container relative">
        ...
        <div className="sofa-img">
          <img src="/images/sofa.png" alt="Sofa" className="img-fluid" style={{ marginTop: '120px' }} />
        </div>
            ...
            <div className="subscription-form">
              ...
              <form className="row gx-2 gy-2 align-items-center">
                ...
                <div className="col-md-4 gy-2">
                  <button type="submit" className="btn-success btn-lg w-100 d-flex justify-content-center align-items-center gy-2" style={{ height: '50px' }}>
        ...
        <div className="row g-5 mb-5 mt-5">
          <div className="col-lg-4">
            ...
            <p className="mb-4">Donec facilisis quam ut purus rutrum lobortis. Donec vitae odio quis nisl dapibus malesuada.</p>
