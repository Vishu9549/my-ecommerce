            ...
            <div className="col-md-12 text-center pt-5">
              <span className="display-3 thankyou-icon text-primary">
                ...
                >
                  <path
                    fillRule="evenodd"
                    d="M11.354 5.646a.5.5 0 0 1 0 .708l-3 3a.5.5 0 0 1-.708 0l-1.5-1.5a.5.5 0 1 1 
                    .708-.708L8 8.293l2.646-2.647a.5.5 0 0 1 .708 0z"
                  />
                  <path
                    fillRule="evenodd"
                    ...
                    0-4zm7 0a2 2 0 1 0 0 4 2 2 0 0 0 
                    0-4zm-7 1a1 1 0 1 0 0 2 1 1 0 0 0 
