                    ...
                    <form action="{{ route('blocks.update', $block->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="heading" class="form-control"
                                        value="{{ old('heading', $block->heading) }}" required>
                                </div>
                                <div class="form-group">
                                    <label>Ordering</label>
                                    <input type="number" name="ordering" class="form-control"
                                        value="{{ old('ordering', $block->ordering) }}">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <button type="button" id="add-feature" class="btn btn-sm btn-outline-primary mt-2">Add
                                        More</button>
                                </div>
                            </div>
                            <div class="col-md-6">
                                ...
                                @foreach(['image', 'image_1', 'image_2', 'image_3'] as $img)
                                    <div class="form-group">
                                        ...
                                        @if ($block->$img)
                                            <div class="mt-2">
                                                <img src="{{ asset('uploads/blocks/' . $block->$img) }}" width="120"
                                                    class="img-thumbnail">
                                            </div>
                                        @endif
                                    </div>
                        ...
                        <div class="form-group mt-4">
                            ...
                            <textarea name="description" id="description" class="form-control"
                                rows="6">{{ old('description', $block->description) }}</textarea>
                        </div>
