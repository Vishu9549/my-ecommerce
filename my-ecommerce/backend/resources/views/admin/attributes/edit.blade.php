    ...
    <form action="{{ route('attributes.update', $attribute->id) }}" method="POST">
        ...
        <div class="row mb-3">
            <div class="col-md-6">
                ...
                <input type="text" name="attribute_name" class="form-control" value="{{ $attribute->attribute_name }}" required>
            </div>
            <div class="col-md-6">
        ...
        <div id="value-repeater">
            @foreach($attribute->values as $index => $value)
                <div class="row mb-2 value-group">
                    ...
                    <div class="col-md-6">
                        <input type="text" name="values[{{ $index }}][value]" class="form-control" value="{{ $value->value_name }}" placeholder="Value Name">
                    </div>
                    <div class="col-md-4">
